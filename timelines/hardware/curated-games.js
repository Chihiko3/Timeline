window.CONSOLE_CURATED_GAMES = {
  "Magnavox-Philips-Magnavox-Odyssey-1972": {
    launchGames: ["Table Tennis", "Ski", "Simon Says", "Tennis", "Hockey", "Football"],
    signatureGames: ["Table Tennis", "Haunted House", "Cat and Mouse", "Roulette", "States", "Submarine"],
    note: "早期专用玩法以随机器材和覆盖膜体验为核心。"
  },
  "Magnavox-Philips-Odyssey-2-Philips-Videopac-G7000-1978": {
    launchGames: ["Speedway!", "Spin-Out!", "Crypto-Logic!", "Bowling!", "Computer Intro!"],
    signatureGames: ["K.C. Munchkin!", "Pick Axe Pete", "The Quest for the Rings", "UFO!", "Attack of the Timelord", "Turtles"]
  },
  "Magnavox-Philips-Philips-CD-i-1991": {
    launchGames: ["Connect Four", "Battleship", "The Palm Springs Open", "Caesars World of Boxing"],
    signatureGames: ["The 7th Guest", "Burn:Cycle", "Hotel Mario", "The Apprentice", "Mad Dog McCree", "International Tennis Open", "Link: The Faces of Evil"]
  },
  ...
  "Atari-Atari-2600-VCS-1977": {
    launchGames: ["Combat", "Air-Sea Battle", "Basic Math", "Blackjack", "Indy 500", "Star Ship", "Street Racer", "Video Olympics"],
    signatureGames: ["Space Invaders", "Adventure", "Pitfall!", "Asteroids", "Missile Command", "Yars' Revenge", "River Raid", "Kaboom!", "Combat", "Warlords", "H.E.R.O.", "Solaris"]
  },
  "Atari-Atari-5200-1982": {
    launchGames: ["Super Breakout", "Galaxian", "Space Invaders", "Missile Command"],
    signatureGames: ["Star Raiders", "Robotron: 2084", "Centipede", "Joust", "Qix", "Pole Position", "Pac-Man", "Defender"]
  },
  "Atari-Atari-7800-1986": {
    launchGames: ["Asteroids", "Centipede", "Joust", "Ms. Pac-Man", "Pole Position II", "Robotron: 2084", "Xevious"],
    signatureGames: ["Food Fight", "Ballblazer", "Ninja Golf", "Desert Falcon", "Galaga", "Commando", "Donkey Kong Jr.", "Alien Brigade"]
  },
  "Atari-Atari-Lynx-1989": {
    launchGames: ["California Games", "Blue Lightning", "Electrocop", "Gates of Zendocon"],
    signatureGames: ["Chip's Challenge", "Todd's Adventures in Slime World", "Rygar", "Rampart", "Klax", "Warbirds", "Toki", "RoadBlasters"]
  },
  "Atari-Atari-Jaguar-1993": {
    launchGames: ["Cybermorph", "Trevor McFur in the Crescent Galaxy"],
    signatureGames: ["Tempest 2000", "Alien vs Predator", "Rayman", "Doom", "Wolfenstein 3D", "Iron Soldier", "Power Drive Rally"]
  },
  ...
  "Nintendo-Virtual-Boy-1995": {
    launchGames: ["Mario's Tennis", "Galactic Pinball", "Red Alarm", "Teleroboxer"],
    signatureGames: ["Virtual Boy Wario Land", "Mario's Tennis", "Teleroboxer", "Red Alarm", "Galactic Pinball", "Jack Bros."]
  },
  "Nintendo-Nintendo-64-1996": {
    launchGames: ["Super Mario 64", "Pilotwings 64", "Saikyo Habu Shogi"],
    signatureGames: ["Super Mario 64", "The Legend of Zelda: Ocarina of Time", "GoldenEye 007", "Mario Kart 64", "Majora's Mask", "Super Smash Bros.", "Banjo-Kazooie", "Perfect Dark", "Star Fox 64", "Paper Mario"]
  },
  "Nintendo-Nintendo-64DD-1999": {
    launchGames: ["Mario Artist: Paint Studio", "Doshin the Giant"],
    signatureGames: ["Mario Artist: Paint Studio", "Mario Artist: Talent Studio", "Mario Artist: Polygon Studio", "Doshin the Giant", "F-Zero X Expansion Kit", "SimCity 64"]
  },
  "Nintendo-Game-Boy-Color-1998": {
    launchGames: ["Tetris DX", "Wario Land II", "Pocket Bomberman", "Game & Watch Gallery 2"],
  ...
  "Nintendo-Wii-2006": {
    launchGames: ["Wii Sports", "The Legend of Zelda: Twilight Princess", "Red Steel", "Rayman Raving Rabbids", "Excite Truck"],
  ...
  "Nintendo-Wii-U-2012": {
    launchGames: ["Nintendo Land", "New Super Mario Bros. U", "ZombiU", "Scribblenauts Unlimited"],
    signatureGames: ["Mario Kart 8", "Super Mario 3D World", "Splatoon", "The Legend of Zelda: Breath of the Wild", "Super Smash Bros. for Wii U", "Bayonetta 2", "Donkey Kong Country: Tropical Freeze", "Pikmin 3", "The Wonderful 101"]
  },
  "Nintendo-Nintendo-Switch-2017": {
    launchGames: ["The Legend of Zelda: Breath of the Wild", "1-2-Switch", "Snipperclips", "Super Bomberman R"],
    signatureGames: ["The Legend of Zelda: Breath of the Wild", "Super Mario Odyssey", "Mario Kart 8 Deluxe", "Animal Crossing: New Horizons", "Super Smash Bros. Ultimate", "Tears of the Kingdom", "Splatoon 3", "Metroid Dread", "Fire Emblem: Three Houses", "Ring Fit Adventure"]
  },
  "Nintendo-Nintendo-Switch-2-2025": {
    launchGames: ["Mario Kart World", "Nintendo Switch 2 Welcome Tour", "Cyberpunk 2077: Ultimate Edition", "Street Fighter 6"],
    signatureGames: ["Mario Kart World", "Donkey Kong Bananza", "The Legend of Zelda: Breath of the Wild - Switch 2 Edition", "The Legend of Zelda: Tears of the Kingdom - Switch 2 Edition", "Street Fighter 6"]
  },
  "Sega-SG-1000-1983": {
  ...
  "Sony-PlayStation-PlayStation-4-2013": {
    launchGames: ["Knack", "Killzone: Shadow Fall", "Resogun", "Assassin's Creed IV: Black Flag", "Call of Duty: Ghosts"],
    signatureGames: ["Bloodborne", "God of War", "Marvel's Spider-Man", "The Last of Us Part II", "Horizon Zero Dawn", "Uncharted 4", "Ghost of Tsushima", "Persona 5 Royal", "Death Stranding"]
  },
  "Sony-PlayStation-PlayStation-5-2020": {
    launchGames: ["Astro's Playroom", "Demon's Souls", "Marvel's Spider-Man: Miles Morales", "Sackboy: A Big Adventure", "Godfall"],
  ...
  "Microsoft-Xbox-Xbox-2001": {
    launchGames: ["Halo: Combat Evolved", "Dead or Alive 3", "Project Gotham Racing", "Oddworld: Munch's Oddysee", "Amped"],
    signatureGames: ["Halo: Combat Evolved", "Halo 2", "Ninja Gaiden Black", "Star Wars: Knights of the Old Republic", "Fable", "Forza Motorsport", "Project Gotham Racing 2", "Jet Set Radio Future", "Morrowind"]
  },
  "Microsoft-Xbox-Xbox-360-2005": {
    launchGames: ["Project Gotham Racing 3", "Perfect Dark Zero", "Kameo", "Call of Duty 2", "Condemned: Criminal Origins"],
    signatureGames: ["Halo 3", "Gears of War", "Mass Effect", "BioShock", "Forza Motorsport 4", "Fable II", "Left 4 Dead 2", "Skyrim", "Braid", "Limbo", "Geometry Wars"]
  },
  "Microsoft-Xbox-Xbox-One-2013": {
    launchGames: ["Forza Motorsport 5", "Ryse: Son of Rome", "Dead Rising 3", "Killer Instinct", "Zoo Tycoon"],
    signatureGames: ["Forza Horizon 4", "Halo 5", "Gears 5", "Ori and the Blind Forest", "Ori and the Will of the Wisps", "Sunset Overdrive", "Sea of Thieves", "Cuphead", "Killer Instinct"]
  },
  "Microsoft-Xbox-Xbox-Series-X-S-2020": {
    launchGames: ["Yakuza: Like a Dragon", "Assassin's Creed Valhalla", "Gears Tactics", "The Falconeer", "Tetris Effect: Connected"],
  ...
  "NEC-Hudson-PC-Engine-CD-ROM2-TurboGrafx-CD-1988": {
    ...
    signatureGames: ["Ys Book I & II", "Castlevania: Rondo of Blood", "Gate of Thunder", "Lords of Thunder", "Spriggan", "Tengai Makyo II", "Snatcher", "Valis II"]
  },
  "NEC-Hudson-PC-Engine-SuperGrafx-1989": {
    launchGames: ["Battle Ace"],
  ...
  "NEC-Hudson-PC-FX-1994": {
    ...
    signatureGames: ["Team Innocent", "Battle Heat", "Kishin Douji Zenki FX", "Blue Breaker", "Farland Story FX", "Chip-chan Kick!"]
  },
  "SNK-Neo-Geo-AES-1990": {
    launchGames: ["NAM-1975", "Magician Lord", "Baseball Stars Professional", "Top Player's Golf"],
    signatureGames: ["Metal Slug", "The King of Fighters '98", "Samurai Shodown II", "Garou: Mark of the Wolves", "Fatal Fury Special", "Magician Lord", "Pulstar", "Blazing Star", "Neo Turf Masters"]
  },
  "SNK-Neo-Geo-CD-1994": {
    launchGames: ["Fatal Fury Special", "Samurai Shodown", "Art of Fighting 2"],
  ...
  "Mattel-Coleco-Fairchild-Fairchild-Channel-F-1976": {
    launchGames: ["Video Blackjack", "Video Whizball", "Video Olympics", "Space War"],
    signatureGames: ["Video Blackjack", "Video Whizball", "Space War", "Maze", "Shooting Gallery"]
  },
  "Mattel-Coleco-Fairchild-Mattel-Intellivision-1979": {
    launchGames: ["Las Vegas Poker & Blackjack", "Major League Baseball", "Armor Battle", "Backgammon"],
    signatureGames: ["Astrosmash", "Advanced Dungeons & Dragons", "Night Stalker", "BurgerTime", "B-17 Bomber", "Utopia", "Major League Baseball", "Tron Deadly Discs"]
  },
  "Mattel-Coleco-Fairchild-ColecoVision-1982": {
    launchGames: ["Donkey Kong", "Zaxxon", "Lady Bug", "Smurf: Rescue in Gargamel's Castle"],
    signatureGames: ["Donkey Kong", "Zaxxon", "Smurf: Rescue in Gargamel's Castle", "Lady Bug", "Mouse Trap", "Pepper II", "Venture", "Time Pilot"]
  },
  "GCE-Milton-Bradley-Microvision-1979": {
    launchGames: ["Block Buster", "Pinball", "Connect Four"],
    signatureGames: ["Block Buster", "Pinball", "Connect Four", "Mindbuster", "Star Trek Phaser Strike", "Sea Duel", "Alien Raiders"]
  },
  "GCE-Milton-Bradley-Vectrex-1982": {
    launchGames: ["Mine Storm", "Scramble", "Star Trek: The Motion Picture"],
    signatureGames: ["Mine Storm", "Scramble", "Star Castle", "Armor Attack", "Berzerk", "Web Wars", "Cosmic Chasm", "Spike"]
  },
  "Epoch-Cassette-Vision-1981": {
    launchGames: ["Kikori no Yosaku", "Baseball"],
    signatureGames: ["Kikori no Yosaku", "Baseball", "Galaxian", "Monster Mansion", "Battle Vader", "PakPak Monster"]
  },
  "Epoch-Super-Cassette-Vision-1984": {
    launchGames: ["Astro Wars II", "Punch Boy"],
    signatureGames: ["Dragon Slayer", "Mappy", "Sky Kid", "Kung Fu Road", "Astro Wars II", "Super Golf", "Pop & Chips"]
  },
  "Tiger-Watara-Watara-Supervision-1992": {
    launchGames: ["Crystball", "Hash Blocks", "Chimera"],
    signatureGames: ["Crystball", "Hash Blocks", "Chimera", "Journey to the West", "Hero Kid", "Delta Hero", "Dream World"]
  },
  "Tiger-Watara-Game-com-1997": {
    launchGames: ["Lights Out", "Mortal Kombat Trilogy", "Wheel of Fortune"],
    signatureGames: ["Lights Out", "Sonic Jam", "Resident Evil 2", "Duke Nukem 3D", "Mortal Kombat Trilogy", "Fighters Megamix"]
  },
  "Apple-Bandai-Casio-Bandai-Playdia-1994": {
    launchGames: ["Dragon Ball Z: Shin Saiyajin Zetsumetsu Keikaku", "Sailor Moon S: Quiz Taiketsu!"],
    signatureGames: ["Dragon Ball Z: Shin Saiyajin Zetsumetsu Keikaku", "Sailor Moon S: Quiz Taiketsu!", "Ultraman Powered", "SD Gundam Daizukan", "Element Voice Series"]
  },
  "Apple-Bandai-Casio-Casio-Loopy-1995": {
    launchGames: ["Wan Wan Aijou Monogatari", "Anime Land"],
    signatureGames: ["Wan Wan Aijou Monogatari", "Anime Land", "HARIHARI Seal Paradise", "Bow-wow Puppy Love Story", "Dream Change"]
  },
  "Apple-Bandai-Casio-Apple-Pippin-1996": {
    launchGames: ["Racing Days", "Super Marathon"],
  ...
  "3DO-Panasonic-3DO-Interactive-Multiplayer-1993": {
    launchGames: ["Crash 'n Burn", "Total Eclipse", "Escape from Monster Manor", "Trip'd"],
    signatureGames: ["The Need for Speed", "Road Rash", "Star Control II", "Super Street Fighter II Turbo", "Gex", "Return Fire", "Lucienne's Quest", "D"]
  },
  "Nokia-N-Gage-2003": {
    launchGames: ["Tony Hawk's Pro Skater", "Tomb Raider", "SonicN", "Puyo Pop"],
