...
- **中英文界面**：中文与英文共用同一套时间线数据和交互；英文当前为明确标记的未校对版本。
...
[查看完整的资料采集与校验说明](RESEARCH_SOURCES.md)
...
使用 AI 协助新增时间线或修改项目时，请先提供 [`AI_PROJECT_GUIDE.md`](AI_PROJECT_GUIDE.md)。它集中说明了项目结构、时间线接入流程和不能破坏的共享规则。
